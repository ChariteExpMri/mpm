% estimate pre-orientation T1/MT/PD to template ('AVGT.nii')
function f_estimPreorient2template(mdirs,varargin)
% ==============================================
%%   example without ANTX-tbx
% ===============================================
if 0
    f_estimPreorient2template({'F:\data7\MPM_agBrandt\dat\20220725AB_MPM_12-4'})
